...
function PaymentModal() {
	...
	const photoName = currentCompetitor.Photo.replace('./images/', '').replace('.jpeg', '.jpg');
	const photoUrl = new URL(`../../assets/${photoName}`, import.meta.url).href;

	const backgroundStyle = {
		width: "100%",
		height: "400px",
		background: `linear-gradient(0deg,#29ae65b2,rgba(0,0,0,0) 60%,rgba(0,0,0,0)),url(${photoUrl})`,
